      ...
      case "Chat":
        return (
          <div className="text-[#FFC72C] font-mono text-sm bg-[#FFC72C11] p-2 rounded text-left m-2.5 max-h-[120px] overflow-auto">
            {typeof node.nodeValue === "object" && node.nodeValue !== null
              ? String(
        ...
        return (
          ...
          >
            <div
              ...
              className={
                hasConnection
                  ? "bg-[#FFC72C]  border-2 border-[#FFB300]"
                  : "bg-[#111] border-2 border-[#FFB30088] hover:border-[#FFB300]"
              }
              style={{
                position: "absolute",
                left: 0,
          ...
          <div className="flex items-center gap-2">
            <div
              className={`w-2.5 h-2.5 rounded-full bg-[#FFC72C] ${
                node.selected || isBeingEdited
                  ? "shadow-[0_0_15px_rgba(255,199,44,0.9)] animate-pulse"
