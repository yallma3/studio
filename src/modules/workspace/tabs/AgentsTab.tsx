      ...
      <div className="bg-[#121212] rounded-md">
        ...
        {agents && agents.length > 0 ? (
                ...
                >
                  ...
                  <div className="mb-4 relative z-10">
                    ...
                    >
                      ...
                      {agent.llmId
                        ? `${
                            availableLLMs.find((llm) => llm.id === agent.llmId)
                              ?.name || agent.llmId
                          }`
                        : `Workspace Default`}
                    </span>
          ...
          <div className="text-zinc-400 py-8 text-center">
            {t(
              "workspaces.noAgents",
              "No agents have been added to this workspace yet"
            )}
          </div>
        )}
      </div>
            ...
            <div className="sticky top-0 bg-[#1d1d1d] p-6 mb-2 border-b border-zinc-800">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold text-white">
                  {isEditing
                    ? t("workspaces.editAgent", "Edit Agent")
                    : t("workspaces.addAgent", "Add New Agent")}
                </h2>
                <button
            ...
            <div className="space-y-4 p-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setAgentForm({ ...agentForm, objective: e.target.value })
                  }
                  placeholder={t(
                    "workspaces.enterObjective",
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setAgentForm({ ...agentForm, background: e.target.value })
                  }
                  placeholder={t(
                    "workspaces.enterBackground",
                    "Enter agent background"
                  )}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setAgentForm({ ...agentForm, capabilities: e.target.value })
                  }
                  placeholder={t(
                    "workspaces.enterCapabilities",
                    "Enter agent capabilities"
                  )}
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setAgentForm({ ...agentForm, llmId: e.target.value })
                  }
                >
                  <option value="">
                    {t("workspaces.useWorkspaceLLM", "Use workspace default")}
                  </option>
                  ...
                  {agentForm.llmId
                    ...
                    : t(
                        ...
                        `Using workspace's main LLM: ${
                          availableLLMs.find(
                            (llm) => llm.id === workspaceData.mainLLM
                          )?.name || "None selected"
                        }`
                      )}
                </p>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={t("workspaces.enterRole", "Enter agent Api Key")}
                />
              </div>
            </div>
