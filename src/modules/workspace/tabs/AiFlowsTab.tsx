          ...
          >
            ...
            <div>
              ...
              <div className="text-xs text-zinc-500">
                {t(
                  "workspaces.importFromDeviceDescription",
          ...
          <div className="flex-1 overflow-y-auto pr-2 space-y-1.5">
            {isLoading ? (
              ...
              <div className="text-center py-8 text-zinc-500 text-sm">
                {t(
                  "workspaces.noAvailableWorkflows",
                  "No workflows available to import"
                )}
              </div>
            ) : (
          ...
          <div className="flex gap-2.5">
            ...
            >
              {isImporting
                ...
                : t("common.import", "Import Selected")}
            </button>
          </div>
        </div>
      </div>
...
const AiFlowsTab: React.FC<AiFlowsTabProps> = ({
  ...
  const handleImportWorkflows = async (workflowIds: string[]) => {
    try {
      ...
      const allWorkflows = await loadAllWorkflowsFromFiles();
      const workflowsToImport = allWorkflows.filter((w) =>
      ...
      <div className="bg-[#121212] rounded-md">
        ...
        {workflows && workflows.length > 0 ? (
          ...
          <div className="text-zinc-400 py-8 text-center">
            {t(
              "workspaces.noFlows",
              "No AI workflows have been added to this workspace yet"
            )}
          </div>
        )}
      </div>
            ...
            <div className="mb-8">
              ...
              >
                <p className="text-zinc-200 leading-relaxed">
                  {deleteCompletely
                    ? t(
                        "workspaces.deleteFlowCompletely",
                    ...
                    : t(
                        "workspaces.removeFlowFromWorkspace",
