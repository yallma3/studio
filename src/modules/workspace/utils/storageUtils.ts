...
const regenerateWorkspaceIds = async (
...
export const loadWorkspaceState = async (): Promise<WorkspaceSaveResult> => {
  try {
    ...
    const workspaceStateWithNewIds = await regenerateWorkspaceIds(
      originalWorkspaceData
    );
...
export const loadWorkspaceStateFromPath = async (
  ...
  try {
    ...
    // Regenerate all IDs for the imported workspace
    const workspaceDataWithNewIds = await regenerateWorkspaceIds(
      originalWorkspaceData
    );
...
export const saveFavoriteWorkspaces = async (
...
export const saveWorkspaceToDefaultLocation = async (
  workspaceState: WorkspaceData
): Promise<WorkspaceSaveResult> => {
  try {
    // Use ID for file name instead of name
